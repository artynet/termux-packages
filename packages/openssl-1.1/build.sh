...
termux_step_make_install() {
	...
	mv $TERMUX_PREFIX/lib/libcrypto.so.1.1 $TERMUX_PREFIX/lib/libcrypto-1.1.so
	mv $TERMUX_PREFIX/lib/libssl.so.1.1 $TERMUX_PREFIX/lib/libssl-1.1.so
	mv $TERMUX_PREFIX/lib/libcrypto.a $TERMUX_PREFIX/lib/libcrypto-1.1.a
	mv $TERMUX_PREFIX/lib/libssl.a $TERMUX_PREFIX/lib/libssl-1.1.a
	mv $TERMUX_PREFIX/lib/pkgconfig/openssl.pc $TERMUX_PREFIX/lib/pkgconfig/openssl-1.1.pc
	mv $TERMUX_PREFIX/lib/pkgconfig/libssl.pc $TERMUX_PREFIX/lib/pkgconfig/libssl-1.1.pc
	mv $TERMUX_PREFIX/lib/pkgconfig/libcrypto.pc $TERMUX_PREFIX/lib/pkgconfig/libcrypto-1.1.pc
	sed -e 's|/include$|/include/openssl-1.1|' -i $TERMUX_PREFIX/lib/pkgconfig/openssl-1.1.pc $TERMUX_PREFIX/lib/pkgconfig/libssl-1.1.pc $TERMUX_PREFIX/lib/pkgconfig/libcrypto-1.1.pc
}
